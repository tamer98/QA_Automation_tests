...
public class RegisterTc {
	...
	public void simple() throws InterruptedException {
		...
		Thread.sleep(timedelay);
		register.enterFirstName("toto");
		Thread.sleep(timedelay);
		register.enterLastName("soso");
		Thread.sleep(timedelay);
		register.enterMail("soso@gmail.com");
		Thread.sleep(timedelay);
		register.enterPhone("12344");
		Thread.sleep(timedelay);
		register.enterPass("soso");
		Thread.sleep(timedelay);
		register.enterPassConfirm("soso");
		Thread.sleep(timedelay);
	...
	public static void main(String args[]) {
		...
		org.junit.runner.Result result = junit.run(RegisterTc.class); // Replace "SampleTest" with the name of your class
